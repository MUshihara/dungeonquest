...
logKV("START", {
    ...
    samurai_full_safe_shift_only = true,
    samurai_physical_pocket_reject = true,
    miyamoto_beam_premove_during_old_wave = true,
